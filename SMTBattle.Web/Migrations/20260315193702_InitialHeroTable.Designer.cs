...
namespace SMTBattle.Web.Migrations
{
    ...
    [Migration("20260315193702_InitialHeroTable")]
    partial class InitialHeroTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMTBattle.Web.Models.Hero", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SMTBattle.Web.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SMTBattle.Web.Models.Hero", b =>
                {
                    b.HasOne("SMTBattle.Web.Models.User", "User")
                        .WithOne("HeroUnit")
                        .HasForeignKey("SMTBattle.Web.Models.Hero", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
